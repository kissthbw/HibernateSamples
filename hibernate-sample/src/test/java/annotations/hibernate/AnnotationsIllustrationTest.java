...
public class AnnotationsIllustrationTest extends TestCase {
	...
	protected void setUp() throws Exception {
		...
		final StandardServiceRegistry registry = new StandardServiceRegistryBuilder()
				.configure( "hibernate-annotations.cfg.xml" ) // configures settings from hibernate.cfg.xml
				.build();
		try {
	...
	public void testBasicUsage() {
		...
		session.save( new Event( "Our very first annotation event!", new Date() ) );
		session.save( new Event( "A follow up annotation event", new Date() ) );
